...
public class TaskExecutor {
    ...
    private static Executor sUIExecutor;
    ...
    public static Executor getUIPool() {
        if (sUIExecutor == null) {
            synchronized (TaskExecutor.class) {
                if (sUIExecutor == null) {
                    sUIExecutor = new Executor() {
                        @Override
    ...
    private static Executor getCpuPool() {
        if (sCpuPool == null) {
            synchronized (TaskExecutor.class) {
                if (sCpuPool == null) {
    ...
    private static Executor getSerialPool() {
        if (sSerialPool == null) {
            synchronized (TaskExecutor.class) {
                if (sSerialPool == null) {
    ...
    private static Executor getCachePool() {
        if (sCachePool == null) {
            synchronized (TaskExecutor.class) {
                if (sCachePool == null) {
